...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" id="divJudgeScores" class="panel panel-default" visible="false">
        ...
        <div class="panel-body">
            <asp:FormView ID="ContestantScoresFV" runat="server" DefaultMode="ReadOnly" DataSourceID="ContestantScoreDetailsLDS">
                <EditItemTemplate>
                    <div class="row form-group">
    ...
    <a id="SubmitBtn" runat="server" href="#" class="btn btn-primary btn-lg btn-block" onserverclick="SubmitBtn_ServerClick" visible="false">Submit Scores</a>
