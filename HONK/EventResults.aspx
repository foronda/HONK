...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        <h1 style="text-align: center"><strong>EVENT RESULTS</strong></h1>
    </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <asp:UpdatePanel runat="server" ID="MasterGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:GridView ID="MasterGV" runat="server" AllowPaging="False" DataSourceID="MasterDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True"
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <asp:UpdatePanel runat="server" ID="KeikiKaneGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:GridView ID="KeikiKaneGV" runat="server" AllowPaging="True" DataSourceID="KeikiKaneDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                        <Columns>
                                            <asp:BoundField DataField="entry_num_fri" HeaderText="Fri Entry No." SortExpression="entry_num_fri" />
                                            <asp:BoundField DataField="entry_num_sat" HeaderText="Sat Entry No." SortExpression="entry_num_sat" />
                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <asp:UpdatePanel runat="server" ID="KeikiWahineGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:GridView ID="KeikiWahineGV" runat="server" AllowPaging="True" DataSourceID="KeikiWahineDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                        <Columns>
                                            <asp:BoundField DataField="entry_num_fri" HeaderText="Fri Entry No." SortExpression="entry_num_fri" />
                                            <asp:BoundField DataField="entry_num_sat" HeaderText="Sat Entry No." SortExpression="entry_num_sat" />
                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <asp:UpdatePanel runat="server" ID="OpioKaneGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:GridView ID="OpioKaneGV" runat="server" AllowPaging="True" DataSourceID="OpioKaneDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                        <Columns>
                                            <asp:BoundField DataField="entry_num_fri" HeaderText="Fri Entry No." SortExpression="entry_num_fri" />
                                            <asp:BoundField DataField="entry_num_sat" HeaderText="Sat Entry No." SortExpression="entry_num_sat" />
                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <asp:UpdatePanel runat="server" ID="OpioWahineGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:GridView ID="OpioWahineGV" runat="server" AllowPaging="True" DataSourceID="OpioWahineDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                        <Columns>
                                            <asp:BoundField DataField="entry_num_fri" HeaderText="Fri Entry No." SortExpression="entry_num_fri" />
                                            <asp:BoundField DataField="entry_num_sat" HeaderText="Sat Entry No." SortExpression="entry_num_sat" />
                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            <asp:UpdatePanel runat="server" ID="CostumeOpioGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                                <ContentTemplate>
                                                    <asp:GridView ID="CostumeOpioGV" runat="server" AllowPaging="True" DataSourceID="CostumeOpioDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                                        <Columns>
                                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
                                                            <asp:BoundField DataField="age_name" HeaderText="Age" SortExpression="age_name" />
                                                            <asp:BoundField DataField="gender_name" HeaderText="Gender" SortExpression="gender_name" />
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                            <asp:UpdatePanel runat="server" ID="CostumeKeikiGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                                <ContentTemplate>
                                                    <asp:GridView ID="CostumeKeikiGV" runat="server" AllowPaging="True" DataSourceID="CostumeKeikiDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                                        <Columns>
                                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
                                                            <asp:BoundField DataField="age_name" HeaderText="Age" SortExpression="age_name" />
                                                            <asp:BoundField DataField="gender_name" HeaderText="Gender" SortExpression="gender_name" />
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                        <div class="panel-body">
                                            <asp:UpdatePanel runat="server" ID="CostumePaluaGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                                <ContentTemplate>
                                                    <asp:GridView ID="CostumePaluaGV" runat="server" AllowPaging="True" DataSourceID="CostumePaluaDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                                        <Columns>
                                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
                                                            <asp:BoundField DataField="age_name" HeaderText="Age" SortExpression="age_name" />
                                                            <asp:BoundField DataField="gender_name" HeaderText="Gender" SortExpression="gender_name" />
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <asp:UpdatePanel runat="server" ID="PaluaGVUP" ChildrenAsTriggers="true" UpdateMode="Always">
                                <ContentTemplate>
                                    <asp:GridView ID="PaluaGV" runat="server" AllowPaging="True" DataSourceID="PaluaDS" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowSorting="True" DataKeyNames="id" EmptyDateText="">
                                        <Columns>
                                            <asp:BoundField DataField="entry_num_fri" HeaderText="Fri Entry No." SortExpression="entry_num_fri" />
                                            <asp:BoundField DataField="entry_num_sat" HeaderText="Sat Entry No." SortExpression="entry_num_sat" />
                                            <asp:BoundField DataField="full_name" HeaderText="Name" SortExpression="full_name" />
